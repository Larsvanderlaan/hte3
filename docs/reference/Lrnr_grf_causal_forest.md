...
A direct CATE learner backed by
...
- [`Lrnr_grf_causal_forest$new()`](#method-Lrnr_grf_causal_forest-new)

- [`Lrnr_grf_causal_forest$clone()`](#method-Lrnr_grf_causal_forest-clone)
...
#### Usage
    ...
    Lrnr_grf_causal_forest$clone(deep = FALSE)
