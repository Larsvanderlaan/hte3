...
This class defines an DR meta-learner for the conditional relative
average treatment effect (crr).
...
- [`Lrnr_crr_DR_selector$new()`](#method-Lrnr_crr_DR_selector-new)

- [`Lrnr_crr_DR_selector$get_pseudo_data()`](#method-Lrnr_crr_DR_selector-get_pseudo_data)

- [`Lrnr_crr_DR_selector$clone()`](#method-Lrnr_crr_DR_selector-clone)
...
#### Usage
    ...
    Lrnr_crr_DR_selector$new(treatment_level = NULL, control_level = NULL, ...)
...
#### Usage
    ...
    Lrnr_crr_DR_selector$get_pseudo_data(
      hte3_task,
...
#### Usage
    ...
    Lrnr_crr_DR_selector$clone(deep = FALSE)
